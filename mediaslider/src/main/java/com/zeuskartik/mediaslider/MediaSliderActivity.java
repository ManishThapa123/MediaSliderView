        ...
        public Object instantiateItem(@NonNull ViewGroup container, int position) {
            ...
            if (token.equalsIgnoreCase("image")) {
               ...
               // mProgressBar = view.findViewById(R.id.mProgressBar);
                Glide.with(context).load(urlList.get(position)).fitXY().placeholder(context.getResources().getDrawable(R.drawable.images)).listener(new RequestListener<Drawable>() {
                    @Override
